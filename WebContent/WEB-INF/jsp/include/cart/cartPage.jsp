...
<script>
        ...
        $("button.createOrderButton").click(function () {
           var orderItems = [];
            $(".cartProductItemIfSelected").each(function () {
        	 ...
        	 $.ajax({
        		type: 'post',
        		url: '/fore/orderConfrim.action',
        		data: {orderItem:orderItems},
        		traditional: true,
        		success: function (result) {
        			 location.href = "/fore/buyPage.action";
        		}
        	}); 
    ...
    function syncPrice(pid, num, price) {
        ...
        var page = "/fore/changeOrderItem.action";
        $.post(
            page,
                ...
                <tr orderItem="${oi.id}" class="cartProductItemTR">
                    ...
                    <td>
                        <div class="cartProductLinkOutDiv">
                            <a href="/fore/product.action?pid=${oi.product.id}" class="cartProductLink">${oi.product.name}</a>
