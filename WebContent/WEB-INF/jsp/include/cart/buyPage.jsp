...
<div class="buyPageDiv">
    <form action="/fore/createOrder.action" method="post">
                ...
                <c:forEach items="${orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemTR">
                        ...
                        <td class="orderItemProductInfo">
                            <a href="/fore/product?pid=${oi.product.id}" class="orderItemProductLink">
                                    ${oi.product.name}
                            </a>
        ...
        <div class="orderItemTotalSumDiv">
			...
			<input name="status" value="${param.num}" type="hidden">
