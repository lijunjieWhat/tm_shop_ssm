  ...
  <script>
    ...
    $(function () {
        ...
        $(".addCartLink").click(function () {
            var page = "/fore/checkLogin.action";
            $.get(
                page,
                function (result) {
                    if ("success" == result) {
                        var pid = ${p.id};
                        var num = $(".productNumberSetting").val();
                        var addCartpage = "/fore/addCart.action";
                        $.get(
                            addCartpage,
                            {"product.id": pid, "number": num},
                            function (result) {
                                if ("success" == result) {
                                    ...
                                    $.post("/fore/getCartTotalNumber.action",{},function (result) {
                                    	$("#cartTotalItemNumber").text(result)
                                    })
        ...
        $("button.loginSubmitButton").click(function () {
            ...
            var page = "/fore/loginAjax.action";
            $.get(
                page,
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="productPrice">
            <div class="juhuasuan">
                ...
                <span>此商品即将参加聚划算，<span class="juhuasuanTime">1天20小时</span>后开始，</span>
            </div>
        ...
        <div class="productSaleAndReviewNumber">
            <div>销量 <span class="redColor boldWord"> 10万+</span></div>
            <div>累计评价 <span class="redColor boldWord">${fn:length(p.reviews)} </span></div>
        </div>
        ...
        <div class="buyDiv">
            <a class="buyLink" href="/fore/orderConfrim.action?pid=${p.id}">
   ...
   <div class="productDetailDiv">
    <div class="productDetailTopPart">
        ...
        <a href="#nowhere" class="productDetailTopReviewLink">累计评价 <span
                class="productDetailTopReviewLinkNumber">${fn:length(p.reviews)}</span> </a>
    </div>
   ...
   <%--  <div class="productDetailImagesPart">
    ...
    <div class="productDetailImagesPart">
        <c:forEach items="${p.productDetailImages}" var="pi" varStatus="vs">
            <img src="/img/productDetail/${vs.count+4}.jpg">
        </c:forEach>
    </div>
</div>
</div>