...
<div class="workingArea">
    <ol class="breadcrumb">
        ...
        <li><a href="admin_product_list.action?cid=${p.category.id}">${p.category.name}</a></li>
                ...
                <div>
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_productImage_add.action"
                                ...
                                <table class="addTable">
                                    ...
                                    <tr>
                                        <td>
                                            <input id="filepathSingle" type="file" name="uploadedImageFile" value=""/>
                                        </td>
                                    </tr>
                                    <tr class="submitTR">
                                        <td align="center">
                        ...
                        <c:forEach items="${pisSingle}" var="pi">
                            <tr>
                                ...
                                <td><a deleteLink="true"
                                       href="admin_productImage_delete.action?id=${pi.id}"><span
            ...
            <td class="addPictureTableTD">
                <div>
                    ...
                    <div class="panel panel-warning addPictureDiv">
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_productImage_add.action"
                                  enctype="multipart/form-data">
                                <table class="addTable">
                                    <tr>
